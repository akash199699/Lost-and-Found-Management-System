...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2024 at 05:01 PM
...
(19, NULL, NULL, '2024-05-01', 'home', '13 pro', 'ph', 0);
...
(1, NULL, 'GF63', 'MSI GAMING LAPTOP', 1, '2024-04-01', 'MACE kmg', 'Found', 999.00),
(2, NULL, 'M31', 'SAMSUNG GALAXY M31', 1, '2024-01-01', 'CET', 'Pending', 327.27),
(3, NULL, 'S23', 'Ultra', 1, '2024-04-26', 'MACE', 'Found', 100.00),
...
(7, 'Albert', 'albert', 'albert123@gmail.com', NULL);
...
--
ALTER TABLE `founditems`
  MODIFY `FoundItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `lostitems`
--
ALTER TABLE `lostitems`
  MODIFY `LostItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
